...
def prepare_data(
    ...
    subtomo_size: Annotated[
        int,
        typer.Option(
            help="Length & width of the 3D subtomograms to extract for model fitting. This value must be divisible by 2^{num_downsample_layers}, where {num_downsample_layers} is the number of downsampling layers used in the U-Net."
        ),
    ],
