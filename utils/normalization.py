...
def get_avg_model_input_mean_and_std(tomo_file, subtomo_size, subtomo_depth, subtomo_extraction_strides, standardize, mw_angle, batch_size, num_workers, batches=None, verbose=False):
    """
