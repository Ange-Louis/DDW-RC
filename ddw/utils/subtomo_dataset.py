...
class SubtomoDataset(Dataset):
    ...
    def __init__(
        ...
        self.crop_subtomos_to_depth = crop_subtomos_to_depth
    ...
    def __getitem__(self, index):
        ...
        if self.rotate_subtomos == True:
            ...
            subtomo0 = rotate_vol_around_axis(
                ...
                rot_angle=rot_angle,
                rot_axis=rot_axis,
                output_shape=[self.crop_subtomos_to_depth] + 2 * [self.crop_subtomos_to_size],
            )
            ...
            mw_mask = get_missing_wedge_mask(
                grid_size=[self.crop_subtomos_to_depth] + 2 * [self.crop_subtomos_to_size],
