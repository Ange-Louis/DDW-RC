...
- **Rectangular Cuboid** (2026-07-07): You can now vary the subtomograms depth

## Installation
The first step is to clone this repository, e.g. via
```
git clone https://github.com/Ange-Louis/DDW-RC
cd DDW-RC
```
...
```
conda create -n ddw_rc_env python=3.10.13 pip=23.2.1
conda activate ddw-rc_env
```
...
## Usage
The DeepDeWedge Rectangular Cuboid command line interface provides three commands which correspond to the three steps of the algorithm outlined in our paper:
...
If you have any questions or problems, or if you found a bug in the code, please do not hesitate to [contact us](mailto:al.sammarcelli@outlook.com) or to open an issue on GitHub.
